...
Для автоматического подбора и обучения моделей используется библиотека PyCaret. Пайплайн настроен на сравнение более чем 15 алгоритмов машинного обучения.
